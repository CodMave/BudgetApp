...
import 'expenceAndIncome.dart'; //package of the percentage indicator which is used to display the percentage as diagrammatically
...
double balance =
    6920.73; //variable which shows the value of the current balance

class HomePage extends StatelessWidget {
  double percent = 0.85;

  HomePage({super.key}); //percentage of the balance to the expenses
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            icon: const Icon(Icons
                .menu), //to change the further setting used a hamburger icon
          ),
          actions: [
            IconButton(
              onPressed: () {},
          ...
          bottom: PreferredSize(
            preferredSize:
                const Size.fromHeight(10.0), //App bar size to the bottom side
            child: Container(),
          ),
        ),
        ...
        body: Container(
          ...
          child: SingleChildScrollView(
            child: Center(
              child: Column(
                //I need to place the all the elements as a column
                mainAxisAlignment: MainAxisAlignment
                    .start, //locate the  CircularPercentIndicator to the top of the body
                children: [
                  const SizedBox(height: 10),
                  Container(
                    //container wigit which caries the percentageIndicator
                    height: 270,
                    width: 450,
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        const FractionallySizedBox(
                          //Under the Percentage I have displayed the word remaining
                          widthFactor: 1.0,
                          child: Align(
                            alignment: Alignment.center,
                            child: Padding(
                  ...
                  Positioned(
                    child: Container(
                      //All the percentage indicator is located inside size of 150,450 dimensions of coloured box
                      height: 150,
                      width: 450,
                      margin: const EdgeInsets.only(
                        left: 20,
                      ...
                      child: Stack(
                        children: [
                          const FractionallySizedBox(
                            //then Under the percentage indicator I have created the coloured box which shows the current balance
                            widthFactor: 1.0,
                            child: Align(
                              alignment: Alignment.topCenter,
                              child: Padding(
                          ...
                          Positioned(
                            child: Container(
                              //I have created another space to show the balance
                              height: 90,
                              width: 450,
                              margin: const EdgeInsets.only(
                                left: 30,
